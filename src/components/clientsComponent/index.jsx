...
export const ClientComponent = () => {
    ...
    return (
        <>
            <header class="relative py-10 w-full  mx-auto bg-green-200 flex justify-around">
                ...
                <div class="relative h-11 w-90 min-w-[200px] bg-white flex justify-center rounded">
