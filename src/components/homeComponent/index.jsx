...
return (
    <> 
        ...
        <main class="flex justify-around  w-full min-h-screen  bg-orange-200">
            <section class=" h-full grid mx-auto gap-x-6 max-sm:gap-y-12  min-[425]:grid-cols-2 md:grid-cols-3 md:gap-y-8 xl:gap-x-8 ">
