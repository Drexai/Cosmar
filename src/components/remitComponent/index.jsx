...
export const RemitComponent = () => {
    ...
    return (
        <>
            <header class="relative w-full  mx-auto bg-green-200 flex flex-row">
                ...
                <nav class="relative py-5  w-full h-full bg-green-200 flex justify-around">
                    <form class="w-full flex flex-row flex justify-center">
                            <div class="grid grid-cols-2  gap-7" >
                                ...
                                <label htmlFor="">
                                    </label><input placeholder="Localidad" type="text" />
            ...
            <section class="relative  h-screen w-full     bg-green-200  flex flex-row flex justify-center md:space-x-20">
