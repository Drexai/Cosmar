...
return(
    <>
        ...
        <main class="justify-center h-screen w-full mx-auto max-[320px]:flex-col bg-white flex flex-row bg-yellow-200">
                <fieldset class=" h-3/4 mx-auto bg-white flex flex-row bg-yellow-200 border-solid border-2 border-indigo-600">
                    ...
                    <section class="grid mx-auto min-[425px]:gap-x-6  min-[320]:grid-cols-2 xl:gap-x-8">
